    ...
    return (
        <main className="mt-6">
            <div className="flex items-center my-20">
                <div className="w-3/4">
                    <h1 className="scroll-m-20 text-3xl font-extrabold tracking-tight lg:text-5xl xl:text-7xl">Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 ">Edgar</span>👋</h1>
                ...
                <div className="flex-1">
                    <div className="w-44 h-44 lg:w-52 lg:h-52 mx-auto">
