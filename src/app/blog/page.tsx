...
export default function Blog() {
    ...
    return (
        <main className="container mx-auto my-8 px-4">
            ...
            <p className="text-lg text-gray-600 mb-8">Welcome to the blog! Here you can find all the blog posts.</p>
                    ...
                    <Link href={`/blog/${blog.slug}`} key={blog.slug}>
                        <Card key={blog.slug} className="hover:shadow transition-shadow duration-200">
                            <CardHeader>
                                ...
                                <CardDescription className="text-sm text-gray-500">{formatDate(blog.metadata.publishedAt, false)}</CardDescription>
                            </CardHeader>
                            <CardContent>
