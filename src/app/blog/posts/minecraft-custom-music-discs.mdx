---
title: 'How to setup a Minecraft Server with Custom Music Discs'
publishedAt: '2020-09-24'
summary: 'This is a tutorial on how to setup a Minecraft server with custom music discs using Spigot Plugins.'
---

This tutorial is will show how to add a custom music to a music disk using a spigot server, this was originally done for Minecraft 1.12.2
but should be able to translate to newer versions.

A full example of a working server is available on my Github at [this repo](https://github.com/edgarssilva/minecraft-music-discs).
...
To setup the plugin you need to go onto its website and download it aswell as it's dependency [ProtocolLib](https://www.spigotmc.org/resources/protocollib.1997/). After that move the plugins into the **plugins** folder and run the server.
